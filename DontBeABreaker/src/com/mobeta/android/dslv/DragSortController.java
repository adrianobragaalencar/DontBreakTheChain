...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    public DragSortController(DragSortListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE, 0, 0);
    }
        ...
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if (mRemoveEnabled && mIsRemoving) {
                    ...
                    final int removePoint = mDslv.getWidth() >> 1;
                    if (x > removePoint) {
    ...
    public int viewIdHitPosition(MotionEvent ev, int id) {
        ...
        final int touchPos   = mDslv.pointToPosition(x, y); // includes headers/footers
    ...
    private final GestureDetector.OnGestureListener mFlingRemoveListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public final boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (mRemoveEnabled && mIsRemoving) {
                final int minPos = mDslv.getWidth() / 5;
